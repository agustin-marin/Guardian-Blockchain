...
peer channel create -o 10.208.211.47:7050 -c mychannel -f /opt/gopath/src/github.com/hyperledger/fabric/peer/channel-artifacts/mychannel.tx --tls --cafile $ORDERER_CA
sleep 5
