...
fn () {
    ...
    echo
    peer lifecycle chaincode approveformyorg -o 10.208.211.47:7050 --channelID mychannel --name $1 --version $a --package-id $PACKAGEID --sequence $a --tls --cafile $ORDERER_CA
    echo
    ...
    echo
    peer lifecycle chaincode commit -o 10.208.211.47:7050 --channelID mychannel --name $1 --version $a --sequence $a --tls --cafile $ORDERER_CA 
    echo
